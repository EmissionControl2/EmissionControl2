...
(
  ...
  if [ $(uname -s) == "Darwin" ]; then
    cp -r ../externalResources/Fonts bin/emissionControl.app/Contents/Resources
    chmod 644 bin/emissionControl.app/Contents/Resources/libsndfile/*
    ...
    chmod 444 bin/emissionControl.app/Contents/Resources/libsndfile/*
  fi
)
