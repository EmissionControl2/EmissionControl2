...
public:
  ...
  ecParameter modIntermittencyWidth{
      "modIntermittencyWidth", "modIntermittencyWidth", "", 0, "", 0, 1, 0, 1};

  ecParameterInt streams{"Streams", "4. Streams", "", 1, "", 1, 12, 1, 20};
  al::ParameterMenu streamsLFO{"##streamsLFO"};
  ecParameter modStreamsWidth{
      "modStreamsWidth", "modStreamsWidth", "", 0, "", 0, 1, 0, 1};
  ...
  ecParameter modGrainDurationWidth{
      "modGrainDurationWidth", "modGrainDurationWidth", "", 0, "", 0, 1, 0, 1};

  ecParameter envelope{
      "Envelopeshape", "6. Envelope shape", "", 0.5, "", 0, 1, 0, 1};
  al::ParameterMenu envelopeLFO{"##envelopeLFO"};
  ecParameter modEnvelopeWidth{
      "modEnvelopeWidth", "modEnvelopeWidth", "", 0, "", 0, 1, 0, 1};
  ...
  std::string getCurrentAudioFileName() {
    std::string filename = soundClipFileName
        [soundFile.getModParam(modSoundFileWidth.mParameter->get()) - 1];
