...
public:
   ...
   */
  ecParameter grainRate{"Grain Rate", "", 1,   "",           0.1,
  ...
  ecParameter grainDurationMs{"Grain Dur (ms)", "",   30, "", 0.01, 1000,
                              0.0000001,        10000};
  ...
  ecParameter tapeHead{"Tape Head", "", 0.5, "", 0, 1, 0, 1};
  ...
  ecParameter volumeDB{"Volume (DB)", "", -6, "", -60, 6, -180, 24};
  ...
  ecParameterInt soundFile{"Sound File", "", 1, "", 1, mClipNum, 1, mClipNum};
