...
public: 
   ...
   * 
   * param[in] The duration of the envelope in seconds. 
   * param[in] FROM 0 to 1. A coefficient that determines the ratio of the sustain to the attack and release. 
   *  0 being a rectangular envelope and 1 being a Hann envelope.
