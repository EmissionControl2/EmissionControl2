...
void ecInterface::onDraw(Graphics &g) {
  ...
  VUdataLeft =
    granulator.vuBufferL.getArray(VUdataSize);  // get left data from ringbuffer
...
ecInterface::PresetHandlerState &ecInterface::ECdrawPresetHandler(
