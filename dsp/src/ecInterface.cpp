...
void ecInterface::onDraw(Graphics &g) {
  ...
  ImGui::PushStyleColor(ImGuiCol_FrameBg, (ImVec4)ImColor(0.537f,0.643f,0.675f));
...
void ecInterface::setGUIColors() {
  ImGui::PushStyleColor(ImGuiCol_WindowBg, (ImVec4)ImColor(0.384f,0.443f,0.463f));
  ImGui::PushStyleColor(ImGuiCol_PopupBg, (ImVec4)ImColor(0.384f,0.443f,0.463f));
